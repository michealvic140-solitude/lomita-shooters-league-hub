...
ALTER TABLE public.token_requests REPLICA IDENTITY FULL;
...
DO $$ BEGIN
  ...
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.odds; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.markets; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.token_transactions; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.token_requests; EXCEPTION WHEN OTHERS THEN NULL; END;
